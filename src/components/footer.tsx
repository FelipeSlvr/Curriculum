...
const Footer = () => {
    ...
    return (
            <div className="terminal-panel terminal-chrome relative overflow-hidden flex flex-col justify-between gap-2 px-5 py-4 text-sm text-foreground/80 md:flex-row md:items-center">
