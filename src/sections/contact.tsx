...
export const Contact = () => {
    ...
    return (
            <div id="contact" className="border border-zinc-800 w-full max-w-[300px] h-full max-h-[300px] p-4 flex flex-col items-center">
                <h1 className="text-4xl font-bold text-center mb-6 text-white">{t('sections.contact')}</h1>
